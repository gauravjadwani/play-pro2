...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <li><a href="views/sign_up.html"><i class="fa fa-sign-in" aria-hidden="true"></i>Signup</a></li>
...
<div class="container">
  <div class="row">
      ...
      <div class="col-md-6">
          <form class = "form-horizontal" role = "form" action="controllers/login.php" method="post">
